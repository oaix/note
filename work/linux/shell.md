...
1. [`Shell特殊变量：Shell $0, $#, $*, $@, $?, $$和命令行参数`](https://blog.csdn.net/u011341352/article/details/53215180)
     变量     含义  
     `$0 `     当前脚本的文件名  
...
9. [查找并修改文件名]
10. [shell bash判断文件或文件夹是否存在 - emanlee - 博客园](https://www.cnblogs.com/emanlee/p/3583769.html)(http://blog.csdn.net/inuyasha1121/article/details/51644269)
+ mv    
  mv fromfile tofile
+ raname    
...
12. [更新某个软件](https://askubuntu.com/questions/656545/how-to-update-an-individual-app-through-terminal)
    `sudo apt-get dist-upgrade firefox` or `sudo apt-get upgrade firefox`

13. convert命令将图片转换为gif
...
15. [判断命令是否正常](https://unix.stackexchange.com/questions/22726/how-to-conditionally-do-something-if-a-command-succeeded-or-failed)
```sh
if command ; then
...
16. [while](https://stackoverflow.com/questions/15534595/bash-scripting-multiple-conditions-in-while-loop)
```sh
...
+ [shell中的括号](https://blog.csdn.net/tttyd/article/details/11742241)
  ...
  - 小括号
    (1)单小括号()
    ![c610aac3](images/c610aac3.png)
    (2)双小括号(())
    ![3d36131a](images/3d36131a.png)
  ```sh
  if ($i<5)
  if [ $i -lt 5 ]
  if [ $a -ne 1 -a $a != 2 ]
  ...
  - 中括号
    (1)单中括号[]
    ![a723e20e](images/a723e20e.png)
    (2)双中括号`[[]]`
    ![aa0e9bf2](images/aa0e9bf2.png)
  - 大括号
    (1)拓展　　
  ...
  ```
  (6)符号$后的括号
  ![4290ad60](images/4290ad60.png)
  ![c2c5b31e](images/c2c5b31e.png)
  ![29e1ed32](images/29e1ed32.png)
